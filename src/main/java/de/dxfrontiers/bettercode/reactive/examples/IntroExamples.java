package de.dxfrontiers.bettercode.reactive.examples;
...
public class IntroExamples {
    ...
    private void defer() {
        Mono<UUID> uuid = Mono.defer(() -> Mono.just(UUID.randomUUID()));
    ...
    private void fromIterable() {
        Flux<Integer> numbers = Flux.fromIterable(List.of(2, 3, 5, 7, 11));
